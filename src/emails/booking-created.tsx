...
export default function BookingCreatedEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>New booking at {marinaName} — {checkIn} to {checkOut}</Preview>
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            <Heading style={h1Style}>New Booking Request</Heading>
            <Text style={textStyle}>
              A new booking has been made at <strong>{marinaName}</strong>. Here are the details:
            </Text>
