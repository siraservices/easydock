...
export interface BookingDeniedEmailProps {
  bookingId: string;
  marinaName: string;
  slipName: string;
  checkIn: string;
...
export default function BookingDeniedEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Booking update — {marinaName} from {checkIn} to {checkOut}</Preview>
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            <Heading style={h1Style}>Booking Update</Heading>
            <Text style={textStyle}>
              We&apos;re sorry to let you know that your booking request at <strong>{marinaName}</strong> was
              not approved by the marina. Your payment has not been charged.
            </Text>
            <Text style={textStyle}>
              We encourage you to search for other available slips on EasyDock.
            </Text>
            ...
            <Section style={detailsCardStyle}>
              ...
              <Hr style={hrStyle} />
              <Text style={detailRowStyle}>
                <strong>Amount:</strong> ${totalPrice.toFixed(2)} (not charged)
              </Text>
            </Section>
